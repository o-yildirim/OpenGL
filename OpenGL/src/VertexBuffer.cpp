...
VertexBuffer::VertexBuffer(const void* data, unsigned int size)
{
    ...
    GLCall(glBindBuffer(GL_ARRAY_BUFFER, m_RendererID)); //Select the buffer you want to use data in. (Draw with buffer with id 5 for instance). It is a basic array.
